...
public class PropertiesConfigurer implements BeanFactoryPostProcessor
{

    private final Properties properties;

    public PropertiesConfigurer( Properties properties )
    {
        ...
        throws BeansException
    {
        ...
        BeanDefinitionVisitor visitor = new BeanDefinitionVisitor( new BeanDirectoryResolver() );
